...
if (process.env.NODE_ENV === "production") {
    ...
    MONGO_URL = `mongodb://localhost:27017/${process.env.DB_NAME}`;
}

console.log("MongoDB URL:", MONGO_URL);


const buildTypes = ["PRODUCTION", "STAGING", "DEVELOPMENT"];

const ALLOWED_ROLES = ["admin", "seller", "buyer"];

const REG_TYPES = ["sellerAdmin", "buyer"];
const serviceAccount = require("../utils/serviceKey.json");
...
const sendMail = async (email, otp, name) => {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p style="font-size:0.9em;">Regards,<br />Testing</p>
